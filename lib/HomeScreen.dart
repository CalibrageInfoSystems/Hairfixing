                      ...
                      Align(
                        ...
                        child: CarouselSlider(
                          items: imageList.map((item) => Image.network(
                            'http://182.18.157.215/SaloonApp/Saloon_Repo/'+
                            item.FilePath,
                            fit: BoxFit.fitWidth,
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      onTap: (){
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => slotbookingscreen(branchId: branch.id, branchname: branch.name, branchlocation: branch.address,filepath : branch.filePath)),
                        );
                      },
                              child: Card(
                                shadowColor: Colors.transparent,
